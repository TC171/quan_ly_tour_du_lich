    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview">
        ...
        <?php if($role === 'ADMIN'): ?>
          ...
          <li class="nav-item">
            <a href="<?= BASE_URL_ADMIN ?>?act=lich-trinh" class="nav-link <?= $currentAct === 'hanh_trinh' ? 'active' : '' ?>">
          ...
          <li class="nav-item">
            <a href="<?= BASE_URL_ADMIN ?>?act=khach_trong_dat_tour" class="nav-link <?= $currentAct === 'khach_trong_dat_tour' ? 'active' : '' ?>">
